...
const DashboardChart = () => {
  ...
  // --- THIS IS THE UPDATED CHART DATA ---
  // It now uses the `topEmployeesBySkills` array from your API response.
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[30vh]">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <Bar options={{...chartOptions, plugins: {...chartOptions.plugins, title: {...chartOptions.plugins.title, text: 'Top Employees by Skill Count'}}}} data={topEmployeesChartData} />
      </div>
    </div>
  );
};
